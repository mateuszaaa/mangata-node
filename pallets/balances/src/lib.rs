...
decl_module! {
	pub struct Module<T: Trait<I>, I: Instance = DefaultInstance> for enum Call where origin: T::Origin {
		...
		fn set_balance(
            ...
            log::trace!(target: "mat", "ballances::set_balance");
			ensure_root(origin)?;

			let who = T::Lookup::lookup(who)?;
            log::trace!(target: "mat", "ballances::set_balance verified");
            ...
            log::trace!(target: "mat", "ballances::set_balance dispatching event");
